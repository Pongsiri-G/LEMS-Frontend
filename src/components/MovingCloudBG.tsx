...
export default function MovingCloudBG() {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden bg-[radial-gradient(ellipse_at_center,_rgba(0,163,247,0.2)_0%,_rgba(0,163,247,0.08)_40%,_transparent_80%)]">
