...
export default function Home() {
  ...
  return (
    <ProtectedRoute>
      <main className="flex flex-col justify-start items-center gap-10 pt-5 mt-5 mx-3.5">
          ...
          <div className="flex flex-col justify-start items-center gap-10 mt-5 w-full">
            ...
            <SearchBar onSearch={({ name, tag, status }) => fetchItem(name ?? "", tag ?? "", status ?? "")}>
              <div className="flex flex-col gap-2 w-full flex-1">
                <Link
                  ...
                  className="h-12 px-4 rounded-xl bg-primary flex items-center justify-center hover:scale-90 transition-all active:scale-100 text-white"
                >
                  <div className="flex justify-center items-center gap-3">
                    <BookCheck />
                    <p className="hidden lg:inline">การยืมของฉัน</p>
                  </div>
                </Link>
                <Link
                  ...
                  className=""
                >
                  <div className="p-4 rounded-xl bg-primary flex items-center justify-center hover:scale-90 transition-all h-12 active:scale-100 text-white  gap-3">
                    <History />
                    <p className="hidden lg:inline text-center">ตรวจสอบประวัติการยืม</p>
                  </div>
                </Link>
              </div>
            </SearchBar>
            {itemDetail?.length === 0 && (
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 lg:grid-cols-3 gap-x-10 gap-y-25 pb-10 items-center">
                <div className="flex flex-col justify-center items-center gap-5 col-span-1 sm:col-span-2 lg:col-span-4 z-10">
                  <img
